...
- minha ideia geral, foi conectar as entidades `produto` e `fornecedor`, pois "um produto deve ter um fornecedor", em seguida conectar o `cliente` e o `produto` a nova entidade `venda`.
